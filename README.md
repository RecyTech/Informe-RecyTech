...
|---|---|---|
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. | **Chamorro Acero, Salvador Edward**<br>TB1: Durante las sesiones de brainstorming, he facilitado la discusión para identificar posibles riesgos y estrategias de mitigación.<br>TP: En el transcurso del trabajo práctico, he estado presente en las reuniones planificadas, contribuyendo con sugerencias e ideas para abordar diversos contratiempos, y me he esforzado por mantener una comunicación efectiva para alcanzar los mejores resultados para el proyecto.<br>TB2: En la etapa final, he colaborado en la presentación final del proyecto, respondiendo a preguntas técnicas del público y desarrollando un bounded context .<br><br>**Jorge Arévalo, Ramón Alejandro**<br>TB1: He presentado las evaluaciones de progreso al equipo, resaltando las áreas que necesitan más atención.<br>TP: Durante el desarrollo del trabajo práctico, asisto a reuniones con el equipo para analizar el avance del proyecto y considerar alternativas de solución a implementar.<br>TB2: En la revisión final, he expuesto los resultados obtenidos y las mejoras futuras posibles, desarrollando un bounded context.<br><br>**Morales Montalvo, Omar Andrew**<br>TB1: He documentado los puntos clave de nuestras discusiones para mantener a todos informados y alineados.<br>TP: Durante el desarrollo del trabajo práctico, he estado activamente involucrado en reuniones periódicas con el equipo, donde evaluamos y debatimos el avance del proyecto, además de buscar soluciones a los desafíos encontrados en el proceso de desarrollo. Estas reuniones han sido esenciales para mantenernos enfocados en nuestros objetivos y garantizar que avanzamos en la dirección correcta hacia la consecución de los resultados deseados.<br>TB2: Durante la presentación final, he ayudado a explicar los aspectos técnicos y la lógica detrás de nuestras decisiones, desarrollando un bounded context.<br><br>**Palomino Fano, Cristhofer Sebastian**<br>TB1: En las sesiones de brainstorming, he propuesto ideas de diseño y he evaluado su viabilidad con el equipo.<br>TP: Durante la etapa de creación de los wireframes para la sección de Historial de Viajes y durante el desarrollo del componente, se hizo evidente la relevancia de un diseño inteligente y coherente, respetando las mejores prácticas y consideraciones de usabilidad.<br>TB2: En la presentación final, he demostrado cómo los wireframes y la interfaz de usuario contribuyen al objetivo general del proyecto, desarrollando un bounded context. | La comunicación oral ha sido efectiva dentro del equipo, permitiendo un intercambio fluido de ideas y una comprensión compartida de los objetivos del proyecto. Se continuará fomentando esta comunicación para mantener la colaboración y el progreso del trabajo. |
| Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. | **Chamorro Acero, Salvador Edward**<br>TB1: He escrito notas de las sesiones de brainstorming y las he compartido con el equipo para asegurar la transparencia.<br>TP: Durante el proceso de creación de los wireframes para la sección de Historial de Viajes y el desarrollo del componente, se ha destacado la importancia de un diseño inteligente y coherente, respetando las mejores prácticas y consideraciones de usabilidad.<br>TB2: En la fase final, he redactado la documentación de la presentación final, incluyendo todos los aspectos técnicos y de diseño relacionados con un bounded context.<br><br>**Morales Montalvo, Omar Andrew**<br>TB1: He preparado actas de reunión que resumen los acuerdos y las tareas asignadas.<br>TP: Para el trabajo práctico, hemos implementado un sistema de organización eficiente en nuestras reuniones, donde todos hemos contribuido y llegado a acuerdos para garantizar un desarrollo correcto del proyecto. Todas estas tareas están estrechamente ligadas al código y la estructura del proyecto, orientada al dominio.<br>TB2: En la documentación final, he detallado los resultados del proyecto y las conclusiones extraídas del trabajo realizado, realizando un bounded context.<br><br>**Jorge Arévalo, Ramón Alejandro**<br>TB1: He compilado los resúmenes de progreso y los he distribuido entre los miembros del equipo para mantener a todos informados.<br>TP: Además, he preparado informes de planificación del proyecto, proporcionando seguimiento de los avances, recomendaciones e implementaciones para mejorar la eficiencia y la calidad del proyecto.<br>TB2: En la presentación final, he preparado la documentación escrita para respaldar las presentaciones orales, enfocándome en un bounded context.<br><br>**Palomino Fano, Cristhofer Sebastian**<br>TB1: He redactado los documentos de diseño de interfaz, explicando cada componente y su funcionalidad.<br>TP: En cuanto a mis contribuciones específicas, he diseñado y desarrollado la interfaz de usuario para iniciar sesión en la aplicación web, también diseñé y desarrollé la interfaz de usuario para el proceso de registro de usuarios en la aplicación web, y me encargué de la mayoría de los enrutamientos de los componentes de la aplicación web.<br>TB2: En la fase final, he preparado los documentos de usuario y la guía de uso de la interfaz para la presentación final del proyecto, especialmente para el desarrollo de un bounded context . | La comunicación escrita ha sido crucial para documentar el progreso del proyecto y asegurar la comprensión de los entregables entre los miembros del equipo. Se seguirá manteniendo un enfoque claro y conciso en la comunicación escrita para garantizar la eficacia y la calidad del trabajo. |
...
Los archivos .feature desempeñan un papel esencial en las prácticas de desarrollo de software orientadas al comportamiento, como el Desarrollo Guiado por Comportamiento (BDD). En este contexto, tienen la función de transmitir y automatizar las especificaciones que se encuentran en las historias de usuario. Para el Sprint 1 se aboradaron 10 historias de Usuarios para el Landing Page

| Repository            | Branch | Commit ID                                | Commit Message                | Commit Message Body | Committed on Date       |
| --------------------- | ------ | ---------------------------------------- | ----------------------------- | ------------------- | ----------------------- |
| Testing-RecyTech      | main   | b566ff8fb603509d28f47b3dea40390e7bc76fda | Implementación del feature 1  | -                   | 14 de abril de 2024     |
| Testing-RecyTech      | main   | b566ff8fb603509d28f47b3dea40390e7bc76fda | Implementación del feature 2  | -                   | 14 de abril de 2024     |
| Testing-RecyTech      | main   | b566ff8fb603509d28f47b3dea40390e7bc76fda | Implementación del feature 3  | -                   | 14 de abril de 2024     |
...
| US02 | Iniciar sesión    | UT02 | Pantalla de Inicio de sesión (Desarrollado en Angular)                  |Desarrollo e Implementacion de la Interfaz y servicio para el inicio de sesion.    | 3                 | Jorge Arévalo, Ramón Alejandro         | Done                                  |
| US03 | Desarrollo de Fake Apis | UT03 | Desarrollo en conjunto al equipo de Fake Apis    | Desarrollo e implementacion de fake APIs en conjunto al equipo de trabajo | 4                  | Morales Montalvo, Omar Andrew         | Done                                 |
| US04 | Opción de suscripción         | UT04 | Pantalla de suscripcion del usuario (Desarrollado en Angular) | Desarrollo e Implementacion de la Interfaz y servicio para la suscripcion del usuario. | 3                  | Palomino Fano, Cristhofer Sebastian        | Done                                  |
| US05 | Implementacion Header y Footers | UT05 |Pantalla de cancelacion suscripcion del usuario (Desarrollado en Angular)    | Desarrollo e Implementacion de la Interfaz y servicio para cancelar la suscripcion del usuario. | 2                  | Morales Montalvo, Omar Andrew         | Done                                 |
| US06 | Visualizar catálogo de artefactos        | UT06 | Pantalla de los artefactos electronicos disponibles (Desarrollado en Angular).    | Desarrollo e Implementacion de la Interfaz y servicio para visualizar el catálogo de artefactos | 3                  | Palomino Fano, Cristhofer Sebastian        | Done                                  |
| US07 | Opción de vender Producto              | UT07 | Pantalla de venta de productros (Desarrollado en Angular)    | Desarrollo e Implementacion de la Interfaz y servicio para la venta de productos.   | 3                  | Chamorro Acero, Salvador Edward         | Done    
| US08 | Visualizar estado e información del producto              | UT07 | Visualizar estado e información del producto(Desarrollado en Angular)    | Desarrollo e Implementacion de la Interfaz y servicio para la visualizacion del estado e información del producto  | 3                  |Chamorro Acero, Salvador Edward         | Done    |
|
