...
|---|---|---|
|Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto eningeniería.|**Chamorro Acero, Salvador Edward**<br>TP1:
En el transcurso del trabajo práctico, he estado presente en las reuniones planificadas, contribuyendo con sugerencias e ideas para abordar diversos contratiempos, y me he esforzado por mantener una comunicación efectiva para alcanzar los mejores resultados para el proyecto.<br><br>**Jorge Arévalo, Ramón Alejandro**<br>TP1:<br>
Durante el desarrollo del trabajo práctico, asisto a reuniones con el equipo para analizar el avance del proyecto y considerar alternativas de solución a implementar.<br>**Morales Montalvo, Omar Andrew**<br>TP1:<br>Durante el desarrollo del trabajo práctico, he estado activamente involucrado en reuniones periódicas con el equipo, donde evaluamos y debatimos el avance del proyecto, además de buscar soluciones a los desafíos encontrados en el proceso de desarrollo. Estas reuniones han sido esenciales para mantenernos enfocados en nuestros objetivos y garantizar que avanzamos en la dirección correcta hacia la consecución de los resultados deseados..<br>**Palomino Fano, Cristhofer Sebastian**<br>TP1:<br>Durante la etapa de creación de los wireframes para la sección de Historial de Viajes y durante el desarrollo del componente, se hizo evidente la relevancia de un diseño inteligente y coherente, respetando las mejores prácticas y consideraciones de usabilidad.|La comunicación oral ha sido efectiva dentro del equipo, permitiendo un intercambio fluido de ideas y una comprensión compartida de los objetivos del proyecto. Se continuará fomentando esta comunicación para mantener la colaboración y el progreso del trabajo.|
|Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería.|**Chamorro Acero, Salvador Edward**<br>TP1:Durante el proceso de creación de los wireframes para la sección de Historial de Viajes y el desarrollo del componente, se ha destacado la importancia de un diseño inteligente y coherente, respetando las mejores prácticas y consideraciones de usabilidad.<br><br>**Morales Montalvo, Omar Andrew**<br>TP1:<br>Para el trabajo práctico, hemos implementado un sistema de organización eficiente en nuestras reuniones, donde todos hemos contribuido y llegado a acuerdos para garantizar un desarrollo correcto del proyecto. Todas estas tareas están estrechamente ligadas al código y la estructura del proyecto, orientada al dominio.<br>**Jorge Arévalo, Ramón Alejandro**<br>TP1:<br>Además, he preparado informes de planificación del proyecto, proporcionando seguimiento de los avances, recomendaciones e implementaciones para mejorar la eficiencia y la calidad del proyecto.<br>**Palomino Fano, Cristhofer Sebastian**<br>TP1:<br>En cuanto a mis contribuciones específicas, he diseñado y desarrollado la interfaz de usuario para iniciar sesión en la aplicación web, también diseñé y desarrollé la interfaz de usuario para el proceso de registro de usuarios en la aplicación web, y me encargué de la mayoría de los enrutamientos de los componentes de la aplicación web.|La comunicación escrita ha sido crucial para documentar el progreso del proyecto y asegurar la comprensión de los entregables entre los miembros del equipo. Se seguirá manteniendo un enfoque claro y conciso en la comunicación escrita para garantizar la eficacia y la calidad del trabajo.|
